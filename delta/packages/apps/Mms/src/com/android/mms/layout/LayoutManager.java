...
public class LayoutManager {
    ...
    private void initLayoutParameters(Configuration configuration) {
        mLayoutParams = getLayoutParameters(
                ...
                ? LayoutParameters.WVGA_PORTRAIT
                : LayoutParameters.WVGA_LANDSCAPE);
    ...
    private static LayoutParameters getLayoutParameters(int displayType) {
        switch (displayType) {
            case LayoutParameters.WVGA_LANDSCAPE:
                return new WVGALayoutParameters(LayoutParameters.WVGA_LANDSCAPE);
            case LayoutParameters.WVGA_PORTRAIT:
                return new WVGALayoutParameters(LayoutParameters.WVGA_PORTRAIT);
        }
