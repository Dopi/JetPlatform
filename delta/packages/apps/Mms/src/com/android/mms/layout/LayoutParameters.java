...
public interface LayoutParameters {
    ...
    public static final int WVGA_LANDSCAPE = 10;
    public static final int WVGA_PORTRAIT  = 11;

    /* Parameters for known layouts */
    public static final int WVGA_LANDSCAPE_WIDTH  = 800;
    public static final int WVGA_LANDSCAPE_HEIGHT = 480;
    public static final int WVGA_PORTRAIT_WIDTH   = 480;
    public static final int WVGA_PORTRAIT_HEIGHT  = 800;
