...
public class ConfigurationTest extends AndroidTestCase {
    ...
    private static class ActiveScreenConfiguration {
        ...
        public ActiveScreenConfiguration(int width,
            ...
            this(width, height, Density.findDensity((int) (240.0f * density)));
        }
    ...
    private static final ScreenConfiguration[] SUPPORTED_SCREEN_CONFIGS = {
        ...
        // WVGA      | high (191-250)   | normal
        new ScreenConfiguration(800, 480, Density.HIGH, Configuration.SCREENLAYOUT_SIZE_NORMAL, true),
        // FWVGA     | high (191-250)   | normal
        ...
        // WVGA      | high (191-250) | large
        new ScreenConfiguration(800, 480, Density.HIGH, Configuration.SCREENLAYOUT_SIZE_SMALL, true),
        // FWVGA     | medium (141-190) | large
