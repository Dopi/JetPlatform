...
public class MediaStore_Images_ThumbnailsTest extends InstrumentationTestCase {
    ...
    public void testStoreImagesMediaExternal() {
        ...
        values.put(Thumbnails.HEIGHT, 800);
        values.put(Thumbnails.WIDTH, 480);
        ...
        assertEquals(800, c.getInt(c.getColumnIndex(Thumbnails.HEIGHT)));
        assertEquals(480, c.getInt(c.getColumnIndex(Thumbnails.WIDTH)));
